...
export type Query = {
  ...
  secretLogs?: Maybe<SecretsLogsResponseType>;
...
export type SecretsLogsResponseType = {
  __typename?: 'SecretsLogsResponseType';
