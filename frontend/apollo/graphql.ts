...
export type GetSecretsQuery = { __typename?: 'Query', secrets?: Array<{ __typename?: 'SecretType', id: string, key: string, value: string, tags: Array<string>, comment: string, createdAt?: any | null, history?: Array<{ __typename?: 'SecretEventType', id: string, key: string, value: string, tags: Array<string>, version: number, comment: string, timestamp: any, eventType: ApiSecretEventEventTypeChoices } | null> | null } | null> | null, appEnvironments?: Array<{ __typename?: 'EnvironmentType', id: string, name: string, envType: ApiEnvironmentEnvTypeChoices, identityKey: string } | null> | null, environmentKeys?: Array<{ __typename?: 'EnvironmentKeyType', id: string, identityKey: string, wrappedSeed: string, wrappedSalt: string } | null> | null };
