...
export type GetNetworkPoliciesQuery = { __typename?: 'Query', clientIp?: string | null, networkAccessPolicies?: Array<{ __typename?: 'NetworkAccessPolicyType', id: string, name: string, allowedIps: string, isGlobal: boolean, createdAt: any, updatedAt: any } | null> | null };
