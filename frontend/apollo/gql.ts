...
const documents = {
    ...
    "mutation CreateNewAWSSecretsSync($envId: ID!, $secretName: String!, $arn: String!, $region: String!, $credentialId: ID!) {\n  createAwsSecretSync(\n    envId: $envId\n    secretName: $secretName\n    arn: $arn\n    region: $region\n    credentialId: $credentialId\n  ) {\n    sync {\n      id\n      environment {\n        id\n        name\n        envType\n      }\n      serviceInfo {\n        name\n      }\n      isActive\n      lastSync\n      createdAt\n    }\n  }\n}": types.CreateNewAwsSecretsSyncDocument,
    ...
    "mutation UpdateCfPagesSyncCreds($syncId: ID!, $accessToken: String!, $accountId: String!) {\n  updateCloudflareSyncCredentials(\n    syncId: $syncId\n    accessToken: $accessToken\n    accountId: $accountId\n  ) {\n    sync {\n      id\n    }\n  }\n}": types.UpdateCfPagesSyncCredsDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateNewAWSSecretsSync($envId: ID!, $secretName: String!, $arn: String!, $region: String!, $credentialId: ID!) {\n  createAwsSecretSync(\n    envId: $envId\n    secretName: $secretName\n    arn: $arn\n    region: $region\n    credentialId: $credentialId\n  ) {\n    sync {\n      id\n      environment {\n        id\n        name\n        envType\n      }\n      serviceInfo {\n        name\n      }\n      isActive\n      lastSync\n      createdAt\n    }\n  }\n}"): (typeof documents)["mutation CreateNewAWSSecretsSync($envId: ID!, $secretName: String!, $arn: String!, $region: String!, $credentialId: ID!) {\n  createAwsSecretSync(\n    envId: $envId\n    secretName: $secretName\n    arn: $arn\n    region: $region\n    credentialId: $credentialId\n  ) {\n    sync {\n      id\n      environment {\n        id\n        name\n        envType\n      }\n      serviceInfo {\n        name\n      }\n      isActive\n      lastSync\n      createdAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateNewCfPagesSync($envId: ID!, $projectName: String!, $deploymentId: ID!, $projectEnv: String!, $credentialId: ID!) {\n  createCloudflarePagesSync(\n    envId: $envId\n    projectName: $projectName\n    deploymentId: $deploymentId\n    projectEnv: $projectEnv\n    credentialId: $credentialId\n  ) {\n    sync {\n      id\n      environment {\n        id\n        name\n        envType\n      }\n      serviceInfo {\n        id\n        name\n      }\n      isActive\n      lastSync\n      createdAt\n    }\n  }\n}"): (typeof documents)["mutation CreateNewCfPagesSync($envId: ID!, $projectName: String!, $deploymentId: ID!, $projectEnv: String!, $credentialId: ID!) {\n  createCloudflarePagesSync(\n    envId: $envId\n    projectName: $projectName\n    deploymentId: $deploymentId\n    projectEnv: $projectEnv\n    credentialId: $credentialId\n  ) {\n    sync {\n      id\n      environment {\n        id\n        name\n        envType\n      }\n      serviceInfo {\n        id\n        name\n      }\n      isActive\n      lastSync\n      createdAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation UpdateCfPagesSyncCreds($syncId: ID!, $accessToken: String!, $accountId: String!) {\n  updateCloudflareSyncCredentials(\n    syncId: $syncId\n    accessToken: $accessToken\n    accountId: $accountId\n  ) {\n    sync {\n      id\n    }\n  }\n}"): (typeof documents)["mutation UpdateCfPagesSyncCreds($syncId: ID!, $accessToken: String!, $accountId: String!) {\n  updateCloudflareSyncCredentials(\n    syncId: $syncId\n    accessToken: $accessToken\n    accountId: $accountId\n  ) {\n    sync {\n      id\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query GetAwsSecrets($accessKeyId: String!, $secretAccessKey: String!, $region: String!) {\n  awsSecrets(\n    accessKeyId: $accessKeyId\n    secretAccessKey: $secretAccessKey\n    region: $region\n  ) {\n    name\n    arn\n  }\n}"): (typeof documents)["query GetAwsSecrets($accessKeyId: String!, $secretAccessKey: String!, $region: String!) {\n  awsSecrets(\n    accessKeyId: $accessKeyId\n    secretAccessKey: $secretAccessKey\n    region: $region\n  ) {\n    name\n    arn\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
