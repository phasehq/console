 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateNewGitlabCiSync($envId: ID!, $path: String!, $credentialId: ID!, $resourcePath: String!, $isGroup: Boolean!, $isMasked: Boolean!, $isProtected: Boolean!) {\n  createGitlabCiSync(\n    envId: $envId\n    path: $path\n    credentialId: $credentialId\n    resourcePath: $resourcePath\n    isGroup: $isGroup\n    masked: $isMasked\n    protected: $isProtected\n  ) {\n    sync {\n      id\n      environment {\n        id\n        name\n        envType\n      }\n      serviceInfo {\n        id\n        name\n      }\n      isActive\n      lastSync\n      createdAt\n    }\n  }\n}"): (typeof documents)["mutation CreateNewGitlabCiSync($envId: ID!, $path: String!, $credentialId: ID!, $resourcePath: String!, $isGroup: Boolean!, $isMasked: Boolean!, $isProtected: Boolean!) {\n  createGitlabCiSync(\n    envId: $envId\n    path: $path\n    credentialId: $credentialId\n    resourcePath: $resourcePath\n    isGroup: $isGroup\n    masked: $isMasked\n    protected: $isProtected\n  ) {\n    sync {\n      id\n      environment {\n        id\n        name\n        envType\n      }\n      serviceInfo {\n        id\n        name\n      }\n      isActive\n      lastSync\n      createdAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
