...
const documents = {
    ...
    "mutation CreateNewAWSSecretsSync($envId: ID!, $credentialId: ID!, $secretName: String, $arn: String, $kmsId: String) {\n  createAwsSecretSync(\n    envId: $envId\n    credentialId: $credentialId\n    secretName: $secretName\n    arn: $arn\n    kmsId: $kmsId\n  ) {\n    sync {\n      id\n      environment {\n        id\n        name\n        envType\n      }\n      serviceInfo {\n        name\n      }\n      isActive\n      lastSync\n      createdAt\n    }\n  }\n}": types.CreateNewAwsSecretsSyncDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateNewAWSSecretsSync($envId: ID!, $credentialId: ID!, $secretName: String, $arn: String, $kmsId: String) {\n  createAwsSecretSync(\n    envId: $envId\n    credentialId: $credentialId\n    secretName: $secretName\n    arn: $arn\n    kmsId: $kmsId\n  ) {\n    sync {\n      id\n      environment {\n        id\n        name\n        envType\n      }\n      serviceInfo {\n        name\n      }\n      isActive\n      lastSync\n      createdAt\n    }\n  }\n}"): (typeof documents)["mutation CreateNewAWSSecretsSync($envId: ID!, $credentialId: ID!, $secretName: String, $arn: String, $kmsId: String) {\n  createAwsSecretSync(\n    envId: $envId\n    credentialId: $credentialId\n    secretName: $secretName\n    arn: $arn\n    kmsId: $kmsId\n  ) {\n    sync {\n      id\n      environment {\n        id\n        name\n        envType\n      }\n      serviceInfo {\n        name\n      }\n      isActive\n      lastSync\n      createdAt\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
