...
export const AnimatedLogo = (props: AnimatedLogoProps) => {
  ...
  return (
    ...
    >
      ...
      ></path>
      <line x1="48" y1="145.995" x2="57" y2="145.995" stroke="white" strokeWidth="2" className="svg-elem-5"></line>
      <line x1="228" y1="147.995" x2="236" y2="147.995" stroke="white" strokeWidth="2" className="svg-elem-6"></line>
    </svg>
  )
}
