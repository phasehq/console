...
export const Tag = ({ tag, buttonVariant = 'normal' }: TagProps) => {
  ...
  const variantStyles = {
    ...
    deleted: "bg-red-200 dark:bg-red-950 text-red-500 ph-no-capture line-through rounded-full font-mono",
    added: "bg-emerald-100 dark:bg-emerald-950 text-emerald-500 ph-no-capture rounded-full font-mono",
  }
