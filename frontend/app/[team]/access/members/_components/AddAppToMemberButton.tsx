...
export const AddAppToMemberButton = (props: {
  ...
  // Fetch all apps in the organisation
  ...
  const potentiallyAvailableApps = allAppsData?.apps?.filter((app): app is AppType => app !== null && !memberAppIds.has(app.id)) || []

  // Filter based on search query
  const filteredAvailableApps = 
    searchQuery === ''
      ? potentiallyAvailableApps
      : potentiallyAvailableApps.filter((app: AppType) => 
