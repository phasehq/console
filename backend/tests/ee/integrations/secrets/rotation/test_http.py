...
from ee.integrations.secrets.providers.http import _safe_url, request


@patch("ee.integrations.secrets.providers.http.validate_url_is_safe")
@patch("ee.integrations.secrets.providers.http.settings")
